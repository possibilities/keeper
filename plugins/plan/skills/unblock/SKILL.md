...
- `incident.category` — the typed blocked category (`SPEC_UNCLEAR` / `DEPENDENCY_BLOCKED` / `DESIGN_CONFLICT` / `SCOPE_EXCEEDED` / `EXTERNAL_BLOCKED` / `RESUME_EXHAUSTED`). It decides the move in Phase 2.
