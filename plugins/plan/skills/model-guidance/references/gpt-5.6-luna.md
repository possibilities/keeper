...
<!--
provenance:
  model_id: gpt-5.6-luna       # host-roster capability model (matrix.yaml alias target), NOT an embedded subagents.yaml axis value
  resolves_to: gpt-5.6-luna    # bare capability id served through the codex harness. General GPT-5.6-family model, NOT a `-codex`-tuned variant
