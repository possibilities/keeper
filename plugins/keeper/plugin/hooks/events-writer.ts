 ...
 *   `src/exec-backend.ts` helpers. NO `bun:sqlite`, NO `src/db.ts`: every
 *   import is borrowed from the cold-start budget against the SessionEnd hook's
 *   1.5s timeout cap, and `src/db.ts` is the single biggest line item.
