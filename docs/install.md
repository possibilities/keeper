...
route needs fresh `usageStatus: ok` data plus remaining session and weekly quota; Fable work also needs
remaining Fable quota. Unknown, stale, malformed, signed-out, exhausted, or otherwise unusable routes are
ineligible. Every successful managed Claude launch uses
