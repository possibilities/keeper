...
- The managed CLI has reproducible source provenance, a certificate-backed trusted-application identity, a content-hash-stable pinned generation, and a stable daemon path without mutating a developer checkout.
