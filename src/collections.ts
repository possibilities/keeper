...
/** Durable current Dispatch attempt per target, including released fences. */
export const DISPATCH_CLAIMS_DESCRIPTOR: CollectionDescriptor = {
  ...
  defaultSort: { column: "acquired_at", dir: "desc" },
  filters: {
    verb: "verb",
    id: "id",
