...
test("registry: LIVE_ONLY_PROJECTIONS names exactly git_status + file_attributions + tmux_client_focus, and the 5 live-only jobs columns (3 git counters + 2 tmux location)", () => {
