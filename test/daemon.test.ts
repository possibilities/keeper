...
test("fn-749: the production boot (no selector) spawns the IDENTICAL twenty-three workers", () => {
  ...
  // fn-1239 added `accountObserver` (the optional external-capacity probe; no
  // watcher, no message minter — atomically publishes the PII-free observation
  // sidecar the per-launch account router reads, no DB handle).
